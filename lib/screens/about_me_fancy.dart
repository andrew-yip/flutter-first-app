...
import 'package:helloworldapp/utils/colors.dart';
import 'package:helloworldapp/utils/text_styles.dart';
import 'package:helloworldapp/utils/ui_helpers.dart';
import 'package:helloworldapp/widgets/sexy_tile.dart';

import 'package:dynamic_theme/dynamic_theme.dart';
import 'package:eva_icons_flutter/eva_icons_flutter.dart';
import 'package:gradient_widgets/gradient_widgets.dart';

class AboutMeFancy extends StatefulWidget {
  @override
  _AboutMeFancy createState() => _AboutMeFancy();
}

class _AboutMeFancy extends State<AboutMeFancy> {
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          Text(
                            'andrew yip',
                            style: TextStyle(fontSize: 36, fontWeight: FontWeight.bold, fontStyle: FontStyle.italic, color: MyColors.github),
                          ),
                        ],
                      ),
                    ),
